...
if 'loaded' not in st.session_state:
    ...
    st.session_state.xgb_model = joblib.load("/Users/srimanthdhondy/Programs/Projects/ArogoAI_task/SecondApplication_Task-1/models/depression_anxiety_data.csv_models/xgboost_model.pkl")  # Update if using another model
    st.session_state.label_encoders = joblib.load("/Users/srimanthdhondy/Programs/Projects/ArogoAI_task/SecondApplication_Task-1/encoders/depression_anxiety_data.csv_encoders/label_encoders.pkl")
    st.session_state.target_encoder = joblib.load("/Users/srimanthdhondy/Programs/Projects/ArogoAI_task/SecondApplication_Task-1/encoders/depression_anxiety_data.csv_encoders/target_encoder.pkl")
    st.session_state.X_train = joblib.load("/Users/srimanthdhondy/Programs/Projects/ArogoAI_task/SecondApplication_Task-1/datasets/datasets_pickle/depression_anxiety_data.csv_pickle/X_train.pkl")  # Load training data for LIME
